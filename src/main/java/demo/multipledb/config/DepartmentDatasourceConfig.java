...
@EnableJpaRepositories(
        ...
        basePackages = { "demo.multipledb.repositories.department" })
public class DepartmentDatasourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder, @Qualifier("departmentDatasource") DataSource dataSource) {
        return builder
                .dataSource(dataSource)
                .packages("demo.multipledb.models.department")
